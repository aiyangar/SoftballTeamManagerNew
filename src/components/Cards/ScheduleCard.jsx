              ...
              {game.resultado && (
                <div className='mt-2 p-2 bg-gray-700 rounded'>
                  <p className='text-sm font-semibold text-white'>
                    Marcador: {game.carreras_equipo_local || 0} -{' '}
                    {game.carreras_equipo_contrario || 0}
                  </p>
                  <p
                    className={`text-xs ${
                      game.resultado === 'Victoria'
                        ? 'text-green-400'
                        : game.resultado === 'Derrota'
                          ? 'text-red-400'
                          : 'text-yellow-400'
                    }`}
                  >
            ...
            <div className='grid grid-cols-2 gap-2'>
              {players.map(player => (
                <label key={player.id} className='flex items-center space-x-2'>
                  ...
                  <span
                    className={
                      gameFinalizationStatus[game.id] ? 'text-gray-400' : ''
                    }
                  >
                    {player.nombre}
                  </span>
