            ...
            <div className="bg-neutral-900 border border-gray-600 rounded-lg w-full max-w-2xl mx-4 modal-container">
                <div className="modal-header p-6 border-b border-gray-600">
                    <div className="flex justify-between items-center">
                        <h2 className="text-2xl font-semibold text-white">Detalles del Equipo</h2>
                        <button
                            onClick={onClose}
                ...
                <div className="modal-content p-6">
                    ...
                    <div className="mb-6 p-4 bg-gray-800 rounded-lg">
                        <h3 className="text-xl font-semibold text-white mb-4">{selectedTeam.nombre_equipo}</h3>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div className="flex items-center space-x-3 p-3 bg-gray-700 rounded-lg">
                                ...
                                <div>
                                    <div className="text-white font-semibold text-lg">
                                        {selectedTeam.wins || 0}-{selectedTeam.losses || 0}-{selectedTeam.draws || 0}
                                    </div>
                        ...
                        {selectedTeam.inscripcion && (
                            <div className="mt-4 p-4 bg-gray-700 rounded-lg">
                                <h4 className="text-lg font-semibold text-white mb-3">Estado de Pagos</h4>
                                ...
                                <div className="flex items-center justify-between mb-3">
                                    ...
                                    <span className="text-yellow-400 font-semibold">
                                        ${Math.max(0, (selectedTeam.inscripcion - (selectedTeam.totalRegistrationPaid || 0))).toLocaleString()}
                                    </span>
                                </div>
                                ...
                                <div className="w-full bg-gray-600 rounded-full h-2">
                                    <div 
                                        ...
                                        style={{ 
                                            ...
                                            backgroundColor: (selectedTeam.totalRegistrationPaid || 0) >= selectedTeam.inscripcion 
                                                ? '#10B981' 
                                                : (selectedTeam.totalRegistrationPaid || 0) >= selectedTeam.inscripcion * 0.8
                                                ? '#F59E0B' 
                                                : (selectedTeam.totalRegistrationPaid || 0) >= selectedTeam.inscripcion * 0.5
                                                ? '#F97316' 
                                                : '#DC2626' 
                                        }}
                                    ></div>
                    ...
                    <div className="mb-6 p-4 bg-gray-800 rounded-lg">
                        <h4 className="text-lg font-semibold text-white mb-3">Estadísticas del Equipo</h4>
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            {/* Victorias */}
                            <div className="text-center p-3 bg-green-900 rounded-lg border border-green-600">
                                <div className="text-green-400 text-2xl mb-1">✅</div>
                                <div className="text-white font-bold text-xl">{selectedTeam.wins || 0}</div>
                            ...
                            <div className="text-center p-3 bg-red-900 rounded-lg border border-red-600">
                                ...
                                <div className="text-white font-bold text-xl">{selectedTeam.losses || 0}</div>
                            ...
                            <div className="text-center p-3 bg-yellow-900 rounded-lg border border-yellow-600">
                                ...
                                <div className="text-white font-bold text-xl">{selectedTeam.draws || 0}</div>
                                <div className="text-yellow-300 text-sm">Empates</div>
                            </div>
                        </div>

                        {/* Porcentaje de victorias */}
                        {((selectedTeam.wins || 0) + (selectedTeam.losses || 0) + (selectedTeam.draws || 0)) > 0 && (
                            <div className="mt-4 text-center">
                                <div className="text-gray-300 text-sm mb-1">Porcentaje de Victorias</div>
                                <div className="text-white font-bold text-lg">
                                    {Math.round(((selectedTeam.wins || 0) / ((selectedTeam.wins || 0) + (selectedTeam.losses || 0) + (selectedTeam.draws || 0))) * 100)}%
                                </div>
                            </div>
                        )}
                    </div>
