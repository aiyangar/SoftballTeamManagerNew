          ...
          <div className='bg-neutral-900 shadow rounded-lg p-6 mb-8'>
            ...
            <div className='bg-blue-900 border border-blue-600 rounded-lg p-4 mb-6'>
              ...
              <p className='text-blue-100 text-sm'>
                Al crear un usuario, se enviará un email de confirmación. El
                usuario deberá confirmar su email antes de poder acceder al
                sistema.
              </p>
            </div>
          ...
          <div className='space-y-4 text-gray-300'>
            <div className='bg-yellow-900 border border-yellow-600 rounded-lg p-4'>
              ...
              <ol className='list-decimal list-inside space-y-1 text-sm'>
                ...
                <li>
                  Navega a <strong>Authentication</strong> →{' '}
                  <strong>Settings</strong>
                </li>
                <li>
                  Desactiva <strong>"Enable sign up"</strong> para deshabilitar
                  registro público
                </li>
                <li>
                  Ve a <strong>Authentication</strong> → <strong>Users</strong>{' '}
            ...
            <div className='bg-green-900 border border-green-600 rounded-lg p-4'>
              ...
              <ul className='list-disc list-inside space-y-1 text-sm'>
                ...
                <li>
                  Puedes confirmar usuarios manualmente desde el Dashboard de
                  Supabase
                </li>
                <li>
                  Puedes deshabilitar usuarios desde{' '}
