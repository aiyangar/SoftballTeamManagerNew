  ...
  return (
    <>
      <div>
        ...
        {/* Botones de acción */}
        <div className='mb-6 sm:mb-8 grid grid-cols-2 sm:flex sm:flex-row gap-3'>
          <button
            onClick={() => {
              if (showForm) {
                resetForm();
            ...
            className='btn btn-primary col-span-2 sm:col-span-1 sm:w-auto justify-center'
          >
            <svg
              className='w-5 h-5'
              fill='none'
          ...
          <button
            ...
            className='btn bg-green-600 text-white hover:bg-green-700 sm:w-auto justify-center'
          ...
          <button
            ...
            className='btn bg-purple-600 text-white hover:bg-purple-700 sm:w-auto justify-center'
        ...
        <PaymentModal
          ...
          currentInscripcionPaid={selectedPlayerForPayment ? (playerInscripcionTotals[selectedPlayerForPayment.id] || 0) : 0}
          inscripcionTarget={inscripcionTarget}
          loading={loading}
          onClose={closePaymentModal}
          onProcessPayment={processInscripcionPayment}
        />
        ...
        <ImportPlayersModal
          ...
          selectedTeamToImport={selectedTeamToImport}
          onTeamToImportChange={setSelectedTeamToImport}
          importError={importError}
          onImportErrorClose={() => setImportError(null)}
          importingPlayers={importingPlayers}
