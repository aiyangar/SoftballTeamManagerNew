...
const Players = () => {
  ...
  const fetchPlayerHistory = async (playerId, teamId) => {
    console.log(
      'Obteniendo historial para jugador:',
      playerId,
      'equipo:',
      teamId
    );
    ...
    try {
      ...
      if (!teamId) {
        console.log(
          'No hay equipo específico, obteniendo todos los equipos del usuario'
        );
  ...
  const fetchPlayerInscripcionTotals = async playerIds => {
    ...
    try {
      ...
      console.error(
        'Error inesperado al obtener totales de inscripción:',
        error
      );
      return {};
    }
  ...
  const editPlayer = playerId => {
    ...
    if (player) {
      ...
      setShowForm(true);
      console.log(
        'Formulario de edición abierto con equipo:',
        player.equipo_id || selectedTeam
      );
    } else {
                  ...
                  <div className='flex items-center justify-between'>
                    ...
                    {(filters.nombre ||
                      ...
                      <div className='text-xs text-gray-400'>
                        Filtros activos:
                        {filters.nombre && (
                          <span className='ml-1 px-2 py-1 bg-blue-900 text-blue-200 rounded'>
                            Nombre: {filters.nombre}
                          </span>
                        )}
                        {filters.numero && (
                          <span className='ml-1 px-2 py-1 bg-green-900 text-green-200 rounded'>
