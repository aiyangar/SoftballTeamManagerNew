        ...
        <div className='max-w-md w-full mx-4'>
          <div className='bg-neutral-900 border border-gray-600 rounded-lg p-8 shadow-lg'>
            <div className='text-center'>
              ...
              <h2 className='font-bold pb-2 text-2xl text-white'>
                Registro Deshabilitado
              </h2>

              <div className='mt-4 space-y-4'>
                <p className='text-gray-300 leading-relaxed'>
                  El registro público está actualmente deshabilitado. Solo el
                  administrador puede crear nuevas cuentas de usuario.
                </p>
                ...
                <div className='bg-blue-900 border border-blue-600 rounded-lg p-4'>
                  ...
                  <p className='text-blue-100 text-sm'>
                    Contacta al administrador del sistema para solicitar una
                    cuenta.
                  </p>
                </div>
